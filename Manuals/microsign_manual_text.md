...
![OKボタンをクリック](./images/microsign_manual_text23.png)

#### 表示方法で固定表示を選択した場合

保存した画像がフレームとして追加されます。
![OKボタンをクリック](./images/microsign_manual_text21.png)


#### 表示方法でスクロール表示を選択した場合

続けて「1枚画像からアニメーションを作成する」で表示されたスクロールアニメーションを作成する画像切り抜き画面が表示されます

![画像切り抜き画面](./images/microsign_manual_text22.png)

設定方法は「1枚画像からアニメーションを作成する」を参照ください.

スクロールアニメーションを作成するとアニメーションが登録されます

![画像切り抜き画面](./images/microsign_manual_text24.png)
